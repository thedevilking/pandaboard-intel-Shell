...
if [ $adhoc0_join -eq 1 ];then
	insmod /system/fbaodv_intel.ko $MESH_DEV $AODV_NET $METRIC $RATE $GATEWAY $COM_RADIUS aodv_blacklist="192.168.1.9,192.168.1.8" dtn_blacklist="192.168.1.9,192.168.1.8"
fi
